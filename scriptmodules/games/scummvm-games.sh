...
function run_game_scummvmgames()
{
    ...
    /opt/retropie/emulators/scummvm/bin/scummvm --gfx-mode=1x --no-filtering --aspect-ratio --fullscreen --music-volume=64 --extrapath="/opt/retropie/emulators/scummvm/extra" --path="$path" $shortname
}
